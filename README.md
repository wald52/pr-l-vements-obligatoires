...
S'y ajoutent **46 candidats examinés puis rejetés** (§5) et **9 cas limites**
...
| **Contribution AGEFIPH** (employeurs privés, obligation d'emploi des travailleurs handicapés) | REJET *provisoire* | C2 — l'AGEFIPH **ne figure pas** dans la liste INSEE des ODAC, à la différence du **FIPHFP** (§4.10). L'asymétrie entre deux contributions jumelles était présentée ici comme assumée ; elle est en réalité **fragile**, et le cas est rouvert au §6 depuis que la doctrine du réacheminement est établie. |
...
| **Contribution patronale au dialogue social** (0,016 % de la masse salariale) | REJET *provisoire* | C2 — versée à l'**AGFPN**, association de gestion du fonds paritaire national, **hors périmètre APU**. Elle figure pourtant en ligne 10 du tableau des ressources affectées du PLF 2026 et est recouvrée par l'URSSAF. Cas rouvert au §6. |
