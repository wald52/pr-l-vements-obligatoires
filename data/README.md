...
| `readme_seed` | Socle curé du README (§4 PRIS, §5 REJET) | 86 |
| `supplement_cure` | Ajouts curés à la main (`pipeline/seed/supplement.csv`) | 203 |
| `vm_tome1` | Voies & Moyens Tome I — énumération des lignes budgétaires | 24 |

Après déduplication : **514 prélèvements uniques**.
