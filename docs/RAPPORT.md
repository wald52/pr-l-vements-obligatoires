...
> Généré le 2026-08-09 par le pipeline (`po-pipeline report`). Ne pas éditer à la main.

## Synthèse

| Indicateur | Valeur |
|---|---:|
| Prélèvements retenus (PRIS) | 399 |
| Candidats rejetés (REJET) | 60 |
| Lignes à arbitrer | 1 |
