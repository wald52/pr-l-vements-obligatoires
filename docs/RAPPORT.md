...
> Généré le 2026-08-10 par le pipeline (`po-pipeline report`). Ne pas éditer à la main.

## Synthèse

| Indicateur | Valeur |
|---|---:|
| Prélèvements retenus (PRIS) | 417 |
| Candidats rejetés (REJET) | 68 |
| Lignes à arbitrer | 1 |
...
| Contributions pour le remboursement de la dette sociale (CRDS) | taxe affectée | 8.7 | taxes_affectees |
